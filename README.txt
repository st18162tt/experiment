...
ゲーム「太鼓の達人」を知らない人向けの説明
はじめに
曲とともに流れてくる音符に合わせて太鼓を叩くリズムゲームをプレイしていただきます。まずゲームの説明をします。

画面の説明 (img/display_discription.pngを参照してください)
1. 音符
...
3. 曲が終了したら、shift + Q キーを押してください。keylogger.exeが終了し、同ディレクトリ内に.csvファイルが生成されます。
